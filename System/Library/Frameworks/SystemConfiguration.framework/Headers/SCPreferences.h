...
typedef CF_OPTIONS(uint32_t, SCPreferencesNotification) {
	kSCPreferencesNotificationCommit
		...
		API_UNAVAILABLE( tvos, watchos)	= 1<<0,
	kSCPreferencesNotificationApply
		API_AVAILABLE(macos(4.0))
		API_UNAVAILABLE( tvos, watchos)	= 1<<1
};
 ...
 */
CFTypeID
SCPreferencesGetTypeID			(void)			API_AVAILABLE(macos(10.1)) API_UNAVAILABLE( tvos, watchos);
...
SCPreferencesCreate			(
					...
					)			API_AVAILABLE(macos(10.1)) API_UNAVAILABLE( tvos, watchos);
...
SCPreferencesSetCallback		(
					...
					)			API_AVAILABLE(macos(10.4)) API_UNAVAILABLE( tvos, watchos);
...
SCPreferencesSetDispatchQueue		(
					 ...
					 )			API_AVAILABLE(macos(10.6)) API_UNAVAILABLE( tvos, watchos);
